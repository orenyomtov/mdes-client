...
------------- | ------------- | -------------
[**createTokenize**](TokenizeApi.md#createTokenize) | **POST** /digitization/#env/1/0/tokenize | Used to digitize a card to create a server-based Token.
...
let apiInstance = new MdesForMerchants.TokenizeApi();
let opts = {
