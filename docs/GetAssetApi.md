# MdesForMerchants.GetAssetApi

All URIs are relative to *https://api.mastercard.com/mdes*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getAsset**](GetAssetApi.md#getAsset) | **GET** /assets/#env/1/0/asset/{AssetId} | Used to retrieve static Assets from the MDES repository.
...
let apiInstance = new MdesForMerchants.GetAssetApi();
