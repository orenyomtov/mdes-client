...
export default class DeleteApi {
    ...
    * @alias module:mdes-client/DeleteApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/DeleteApi~deleteDigitizationCallback
     ...
     * @param {module:mdes-client/DeleteApi~deleteDigitizationCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    deleteDigitization(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/delete', 'POST',
