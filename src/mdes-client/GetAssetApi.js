...
/**
* GetAsset service.
* @module mdes-client/GetAssetApi
* @version 1.3.0
*/
export default class GetAssetApi {
    ...
    * @alias module:mdes-client/GetAssetApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/GetAssetApi~getAssetCallback
     ...
     * @param {module:mdes-client/GetAssetApi~getAssetCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    getAsset(assetId, callback) {
      ...
      return this.apiClient.callApi(
        '/assets/#env/1/0/asset/{AssetId}', 'GET',
