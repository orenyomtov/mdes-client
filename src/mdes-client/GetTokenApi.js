...
/**
* GetToken service.
* @module mdes-client/GetTokenApi
* @version 1.3.0
*/
export default class GetTokenApi {
    ...
    * @alias module:mdes-client/GetTokenApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/GetTokenApi~getTokenCallback
     ...
     * @param {module:mdes-client/GetTokenApi~getTokenCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    getToken(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/getToken', 'POST',
