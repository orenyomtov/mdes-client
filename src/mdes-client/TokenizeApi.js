...
/**
* Tokenize service.
* @module mdes-client/TokenizeApi
* @version 1.3.0
*/
export default class TokenizeApi {
    ...
    * @alias module:mdes-client/TokenizeApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/TokenizeApi~createTokenizeCallback
     ...
     * @param {module:mdes-client/TokenizeApi~createTokenizeCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    createTokenize(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/tokenize', 'POST',
