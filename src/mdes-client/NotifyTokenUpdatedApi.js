...
* @module mdes-client/NotifyTokenUpdatedApi
* @version 1.3.0
*/
export default class NotifyTokenUpdatedApi {
    ...
    * @alias module:mdes-client/NotifyTokenUpdatedApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/NotifyTokenUpdatedApi~notifyTokenUpdateForTokenStateChangeCallback
     ...
     * @param {module:mdes-client/NotifyTokenUpdatedApi~notifyTokenUpdateForTokenStateChangeCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    notifyTokenUpdateForTokenStateChange(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/notifyTokenUpdated', 'POST',
