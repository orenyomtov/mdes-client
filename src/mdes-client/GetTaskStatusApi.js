...
* @module mdes-client/GetTaskStatusApi
* @version 1.3.0
*/
export default class GetTaskStatusApi {
    ...
    * @alias module:mdes-client/GetTaskStatusApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/GetTaskStatusApi~getTaskStatusCallback
     ...
     * @param {module:mdes-client/GetTaskStatusApi~getTaskStatusCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    getTaskStatus(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/getTaskStatus', 'POST',
