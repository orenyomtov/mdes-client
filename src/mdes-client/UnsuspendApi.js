...
/**
* Unsuspend service.
* @module mdes-client/UnsuspendApi
* @version 1.3.0
*/
export default class UnsuspendApi {
    ...
    * @alias module:mdes-client/UnsuspendApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/UnsuspendApi~createUnsuspendCallback
     ...
     * @param {module:mdes-client/UnsuspendApi~createUnsuspendCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    createUnsuspend(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/unsuspend', 'POST',
