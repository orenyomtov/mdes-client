...
/**
* Transact service.
* @module mdes-client/TransactApi
* @version 1.3.0
*/
export default class TransactApi {
    ...
    * @alias module:mdes-client/TransactApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/TransactApi~createTransactCallback
     ...
     * @param {module:mdes-client/TransactApi~createTransactCallback} callback The callback function, accepting three arguments: error, data, response
