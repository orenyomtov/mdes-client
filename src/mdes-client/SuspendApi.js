...
export default class SuspendApi {
    ...
    * @alias module:mdes-client/SuspendApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/SuspendApi~createSuspendCallback
     ...
     * @param {module:mdes-client/SuspendApi~createSuspendCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    createSuspend(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/suspend', 'POST',
