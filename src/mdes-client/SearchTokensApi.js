...
* @module mdes-client/SearchTokensApi
* @version 1.3.0
*/
export default class SearchTokensApi {
    ...
    * @alias module:mdes-client/SearchTokensApi
    * @class
    ...
    */
     ...
     * @callback module:mdes-client/SearchTokensApi~searchTokensCallback
     ...
     * @param {module:mdes-client/SearchTokensApi~searchTokensCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    searchTokens(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/digitization/#env/1/0/searchTokens', 'POST',
