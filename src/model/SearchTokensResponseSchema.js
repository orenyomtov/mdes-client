 ...
 * @version 1.3.0
 */
class SearchTokensResponseSchema {
    /**
    ...
    constructor() { 
        ...
        SearchTokensResponseSchema.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchTokensResponseSchema();
 ...
 */
SearchTokensResponseSchema.prototype['responseHost'] = undefined;

/**
 * Unique identifier for the response. 
 * @member {String} responseId
 */
SearchTokensResponseSchema.prototype['responseId'] = undefined;

/**
 * @member {Array.<module:model/Token>} tokens
 */
SearchTokensResponseSchema.prototype['tokens'] = undefined;
...
export default SearchTokensResponseSchema;
