...
class PhoneNumber {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('countryDialInCode')) {
                obj['countryDialInCode'] = ApiClient.convertToType(data['countryDialInCode'], 'Number');
            }
 ...
 * @member {Number} countryDialInCode
 */
PhoneNumber.prototype['countryDialInCode'] = undefined;
