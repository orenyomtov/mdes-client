...
import TokenDetailDataPAROnly from './TokenDetailDataPAROnly';

/**
 * The TokenDetailPAROnly model module.
 * @module model/TokenDetailPAROnly
 * @version 1.3.0
 */
class TokenDetailPAROnly {
    /**
     * Constructs a new <code>TokenDetailPAROnly</code>.
     * @alias module:model/TokenDetailPAROnly
     */
    constructor() { 
        
        TokenDetailPAROnly.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TokenDetailPAROnly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenDetailPAROnly} obj Optional instance to populate.
     * @return {module:model/TokenDetailPAROnly} The populated <code>TokenDetailPAROnly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenDetailPAROnly();
            ...
            if (data.hasOwnProperty('encryptedData')) {
                obj['encryptedData'] = TokenDetailDataPAROnly.constructFromObject(data['encryptedData']);
            }
        }
        return obj;
    }
 ...
 */
TokenDetailPAROnly.prototype['tokenUniqueReference'] = undefined;
 ...
 */
TokenDetailPAROnly.prototype['publicKeyFingerprint'] = undefined;
 ...
 */
TokenDetailPAROnly.prototype['encryptedKey'] = undefined;
 ...
 */
TokenDetailPAROnly.prototype['oaepHashingAlgorithm'] = undefined;
 ...
 * @member {String} iv
 */
TokenDetailPAROnly.prototype['iv'] = undefined;

/**
 * @member {module:model/TokenDetailDataPAROnly} encryptedData
 */
TokenDetailPAROnly.prototype['encryptedData'] = undefined;
...
export default TokenDetailPAROnly;
