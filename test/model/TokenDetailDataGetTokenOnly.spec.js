...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesForMerchants.TokenDetailDataGetTokenOnly();
  });
  ...
  describe('TokenDetailDataGetTokenOnly', function() {
    it('should create an instance of TokenDetailDataGetTokenOnly', function() {
      // uncomment below and update the code to test TokenDetailDataGetTokenOnly
      //var instane = new MdesForMerchants.TokenDetailDataGetTokenOnly();
      //expect(instance).to.be.a(MdesForMerchants.TokenDetailDataGetTokenOnly);
    });

    it('should have the property tokenNumber (base name: "tokenNumber")', function() {
      // uncomment below and update the code to test the property tokenNumber
      //var instane = new MdesForMerchants.TokenDetailDataGetTokenOnly();
