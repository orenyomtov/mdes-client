...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesForMerchants.CardAccountDataOutbound();
  });
  ...
  describe('CardAccountDataOutbound', function() {
    it('should create an instance of CardAccountDataOutbound', function() {
      // uncomment below and update the code to test CardAccountDataOutbound
      //var instane = new MdesForMerchants.CardAccountDataOutbound();
      //expect(instance).to.be.a(MdesForMerchants.CardAccountDataOutbound);
    });
