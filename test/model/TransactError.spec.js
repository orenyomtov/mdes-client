...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesForMerchants.TransactError();
  });
  ...
  describe('TransactError', function() {
    it('should create an instance of TransactError', function() {
      // uncomment below and update the code to test TransactError
      //var instane = new MdesForMerchants.TransactError();
      //expect(instance).to.be.a(MdesForMerchants.TransactError);
    });
