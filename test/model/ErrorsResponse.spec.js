...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesForMerchants.ErrorsResponse();
  });
  ...
  describe('ErrorsResponse', function() {
    it('should create an instance of ErrorsResponse', function() {
      // uncomment below and update the code to test ErrorsResponse
      //var instane = new MdesForMerchants.ErrorsResponse();
      //expect(instance).to.be.a(MdesForMerchants.ErrorsResponse);
    });
