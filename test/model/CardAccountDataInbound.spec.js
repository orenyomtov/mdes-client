...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesForMerchants.CardAccountDataInbound();
  });
  ...
  describe('CardAccountDataInbound', function() {
    it('should create an instance of CardAccountDataInbound', function() {
      // uncomment below and update the code to test CardAccountDataInbound
      //var instane = new MdesForMerchants.CardAccountDataInbound();
      //expect(instance).to.be.a(MdesForMerchants.CardAccountDataInbound);
    });
